    ...
    <div className="mx-auto max-w-5xl py-10">
      <section className="rounded-3xl border bg-gradient-to-r from-emerald-500/10 to-blue-500/10 p-8">
        ...
        <div className="mt-6 flex gap-3">
          <Link href={`/teams/${teamId}`} className="rounded-xl bg-primary px-5 py-3 font-semibold text-primary-foreground">Team Page</Link>
          <Link href={`/brackets?team=${teamId}`} className="rounded-xl border px-5 py-3 font-semibold">Brackets</Link>
        </div>
      </section>
