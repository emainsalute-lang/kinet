...
function MediaCenterPageContent() {
  ...
  const [pressKitForm, setPressKitForm] = useState({ name: "Kinet Creator", role: "Athlete / Creator", achievements: "Showcase top stats, wins, and milestones", links: "Profile, highlights, and contact link" });
  const [pitchForm, setPitchForm] = useState({ creator: "Kinet Creator", audience: "recruiting-focused basketball audience", value: "credible athlete stories, training content, and consistent engagement" });
